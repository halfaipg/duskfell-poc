...
export async function startServer(context) {
  const child = spawn("cargo", ["run", "-p", "sundermere-server"], {
    ...
    env: {
      ...
      ACCOUNT_JWT_HS256_SECRET: context.secret,
      ACCOUNT_JWT_ISSUER: context.issuer,
      ACCOUNT_JWT_AUDIENCE: context.audience,
      MAX_ACTIVE_CONNECTIONS: "5",
      MAX_CONNECTIONS_PER_IP: "5",
      MAX_CONNECTIONS_PER_ACCOUNT: String(context.maxConnectionsPerAccount),
