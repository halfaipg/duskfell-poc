...
const port = Number(args.port ?? 4116);
const runtimeDir = path.resolve("var", "session-capacity-smoke");
...
try {
  ...
  result = {
    ...
    ok:
      ...
      summary.sessionTicketCapacity === 1 &&
      parsedMetrics.sundermere_session_pending_tickets === 1 &&
      parsedMetrics.sundermere_session_ticket_capacity_rejected_total === 1,
  };
} finally {
  if (server) {
